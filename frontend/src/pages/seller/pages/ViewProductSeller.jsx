                      ...
                      <ReviewCard key={index}>
                        <ReviewCardDivision>
                          <Avatar sx={{ width: "60px", height: "60px", marginRight: "1rem", backgroundColor: generateRandomColor(review._id) }}>
                            {review.reviewer && review.reviewer.name ? String(review.reviewer.name).charAt(0) : ''}
                          </Avatar>
                          <ReviewDetails>
                            <Typography variant="h6">{review.reviewer && review.reviewer.name ? review.reviewer.name : ''}</Typography>
