    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton
                    component={Link} to="/Seller/customers"
                    sx={location.pathname.startsWith('/Seller/customers') ? styles.currentStyle : styles.normalStyle}
                >
                    <ListItemIcon>
                        <GroupIcon sx={{ color: location.pathname.startsWith("/Seller/customers") ? '#4d1c9c' : 'inherit' }} />
                    </ListItemIcon>
